...
<body>
	...
	<nav id="navigation-menu">
		<ul>
			...
			<li><a href="login_view.php">Masuk</a></li>
	...
	<div id="content">
		<section id="section-1">			
			<div class="content">
				...
				<h3>Bagikan ide dan karya jeniusmu !</h3>
					<h3>Jadilah solusioner permasalahan daerah asalmu </h3>
						<h3>di KaryaMuda</h3>	
					<h3>Share To Solved</h3>
					<img src="img/diskusi.png" style="	width: 50%;
														height: 30%px; margin-left: 49%; margin-top: -220px;">
													</div>
			<div id= "kotaku">
				<a href="form_komunitas.php">Komunitas</a>
			</div>
			<div id= "kotaku2">
				<a href="form_Mahasiswa.php">Mahasiswa</a>
			</div>
